    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
               ...
               # if i==0:
                #	l=int(body_part.x * image_w)
               # 	s=int(body_part.y * image_h)
                #	image = cv2.rectangle(npimg,(l-65,s-65),(l+75,s+75),(255,255,255),2)
                #	cv2.putText(image, f'P{c}', (l-65, s-65), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
                #	c+=1
            # draw lin
